...
import { DeckSchema } from "../types/common";
...
const convertCsvToJson = (data: RowData, context: GenerationContext): TalentCard => {
...
export const convertTalentCards = (talentCardPath: string, context: GenerationContext) => {
